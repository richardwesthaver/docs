...
This script will install missing core binaries and libraries to the
=infra= stash directory.
- sbcl
- librocksdb
- rust
...
- download and run =cc-install=
- install the latest =infra= lisp core from
