...
:   0: [ABORT] Skip to toplevel REPL.
:   1: [EXIT ] Exit SBCL (calling #'EXIT, killing the process).
: 
: (READ-COMMAND #<SB-IMPL::STRING-INPUT-STREAM {7F13E8A879D3}>)
:    source: (UNDEFINED-COMMAND C ARGS)
: 0] 
** Packy
:PROPERTIES:
...
#:fatal 0.029999
unknown argument: -h
Backtrace for: #<THREAD tid=140288 "main thread" RUNNING {12033C0003}>
0: (FATAL! "-h")
1: ((LAMBDA (&REST SKEL/CLI::ARGS) :IN "/home/ellis/comp/core/skel/cli.lisp") "-h")
2: ((SB-PCL::EMF CALL) #<unused argument> #<unused argument> #<CLI-COMMAND (LAMBDA (&REST ARGS) IN /home/ellis/comp/core/skel/cli.lisp)> ("-h"))
3: (SKEL/CLI::START-SKEL)
