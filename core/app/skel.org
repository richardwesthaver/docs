...
(READ-COMMAND #<SB-IMPL::STRING-INPUT-STREAM {7F65C08AF9D3}>)
...
: #:fatal 0.03
: unknown argument: -h
: Backtrace for: #<THREAD tid=81944 "main thread" RUNNING {1203520003}>
: 0: (FATAL! "-h")
: 1: ((LAMBDA (&REST SKEL/CLI::ARGS) :IN "/home/ellis/comp/core/skel/cli.lisp") "-h")
: 2: (SKEL/CLI::START-SKEL)
: 3: ((FLET SB-UNIX::BODY :IN SB-IMPL::START-LISP))
: 4: ((FLET "WITHOUT-INTERRUPTS-BODY-3" :IN SB-IMPL::START-LISP))
: 5: (SB-IMPL::%START-LISP)
