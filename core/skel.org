...
(READ-COMMAND #<SB-IMPL::STRING-INPUT-STREAM {7F497C5DF9B3}>)
...
#:fatal 0.038999
unknown argument: -h
Backtrace for: #<THREAD tid=276099 "main thread" RUNNING {12036E0003}>
0: (FATAL! "-h")
1: ((LAMBDA (&REST ARGS) :IN "/home/ellis/comp/core/skel/cli.lisp") "-h")
